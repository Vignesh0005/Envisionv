...
const Toolbar = ({ 
  ...
  selectedTool, 
  measurementData, 
  onClearShapes: onClearWorkspace,
  onColorChange,
  onFontColorChange,
  onThicknessChange,
  currentColor,
  ...
  // Update calibration info when currentCalibration prop changes
  useEffect(() => {
    if (currentCalibration) {
      setCalibrationInfo(currentCalibration);
    }
  }, [currentCalibration]);
        ...
        <div className="flex space-x-2">
          ...
          <div className="flex items-center">
            <div className="flex items-center space-x-1 px-2 py-0.5 bg-gray-50 rounded-lg">
              ...
              <button
                onClick={() => {
                  ...
                  if (onClearWorkspace) {
                    ...
                    console.error('onClearWorkspace function not provided');
                  }
                }}
              ...
              {/* Calibration info display next to Clear All */}
              {calibrationInfo && (
