...
const PhaseSegmentation = ({ imagePath, imageUrl, onClose }) => {
    ...
    const handleAnalyzePhases = async () => {
        ...
        console.log('PhaseSegmentation: uploadedImage:', uploadedImage);
        console.log('PhaseSegmentation: imagePath:', imagePath);
        ...
        try {
            ...
            if (uploadedImage) {
                console.log('PhaseSegmentation: Using uploaded image for analysis');
                ...
                console.log('PhaseSegmentation: Sending analyze-upload request');
                ...
                console.log('PhaseSegmentation: Analyze-upload response:', response.data);
                ...
                console.log('PhaseSegmentation: Using image path for analysis');
            ...
            message.error('Failed to analyze phases: ' + (error.response?.data?.message || error.message));
        } finally {
            setLoading(false);
        }
    };
