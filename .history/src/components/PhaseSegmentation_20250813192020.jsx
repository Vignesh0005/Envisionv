...
import { DownOutlined, PlusOutlined, SaveOutlined, SettingOutlined, ArrowLeftOutlined, UploadOutlined } from '@ant-design/icons';
...
const PhaseSegmentation = ({ imagePath, imageUrl, onClose }) => {
    ...
    useEffect(() => {
        ...
        if (!imagePath && !imageUrl) {
            ...
            setError('No image selected. Please select an image in the main application first.');
            setDisplayUrl(null);
            return;
        }
                                ...
                                <div className="flex items-center justify-center h-[400px] bg-gray-50 rounded-lg">
                                    <div className="text-center text-gray-500">
                                        ...
                                        <div className="text-sm">
                                            Please select an image in the main application to analyze
                                        </div>
                                        {error && (
